const shuffle = (list) => {
    // It's important to create a copy of the list to avoid modifying the original array
    let tempList = [...list]; // Corrected to create a shallow copy of the array
...
// Corrected to pass urls directly without wrapping it in another array
